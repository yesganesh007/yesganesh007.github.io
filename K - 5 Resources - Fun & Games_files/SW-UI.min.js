        ...
        var f = c.extend({}, c.fn.validate.defaults, n); c(".error-validation").remove(); c(".failed-validation").removeClass("failed-validation"); var l = !1, g = "", h = 100; return this.each(function () {
            function k(b) {
                var e = b.attr("validationtype"), a = jQuery.trim(b.val()); switch (e) {
                    case "numeric": e = /^[0-9]+$/; "" === a || a.match(e) || d(b); break; case "range": var e = /^[0-9]+$/, f = void 0 === b.attr("min") ? 0 : b.attr("min"), g = void 0 === b.attr("max") ? Infinity : b.attr("max"); "" !== a && (parseInt(f) > a || parseInt(g) <
            ...
            } function d(b) { 0 < b.siblings(".counter:first").length ? b.siblings(".counter:first").after("<div class='error-validation'>" + b.attr("errormessage") + "</div>") : (b.after("<div class='error-validation'>" + b.attr("errormessage") + "</div>"), b.addClass("failed-validation")); l = !0; void 0 !== b.attr("tabstrip") && b.attr("tab") < h && (g = b.attr("tabstrip"), h = b.attr("tab")) } var m = c(this); m.find(".required").each(function () {
...
(function (b) {
    b.fn.swalert = function (h) {
        var d = b.extend({}, b.fn.swalert.defaults, h); return this.each(function (k, h) {
            function g() { b("div[id='" + c + "base']").fadeOut(); a.fadeOut(); a.remove(); l.focus() } b(this); var a, c, l = b("input.focus:first"); l.blur(); var e, f = 0; for (e = "alert" + k + ""; 0 < b("#" + e).length;) f++, e = "_" + f, e = "alert" + k + e; b("body").append('<div id="' + e + '" class="ui-sw-alert ' + d.alertType + ' ui-sw-alert-envelope"></div>'); a = b("#" + e); c = a.attr("id"); a.append("<div class='ui-sw-alert top'></div>"); a.append("<div class='ui-sw-alert body'></div>");
            a.append("<div class='ui-sw-alert footer'></div>"); f = ""; f = "ok" == d.buttonType ? '<a id="' + c + 'ok" class="ui-btn-general-primary" tabindex="0"><span>OK</span></a>' : '<a id="' + c + 'yes" class="ui-btn-general-primary" tabindex="0"><span>Yes</span></a>' + ('<a id="' + c + 'no" class="ui-btn-general" tabindex="0"><span>No</span></a>'); $alertboxBody = a.find(".body"); $alertboxBody.append("<div class='ui-sw-alert icon " + d.alertType + "'></div>"); $alertboxBody.append("<div class='ui-sw-alert text'>" + function (a) {
                var c = /<\/([\s]*)script>/ig;
                return /<script.*?>/ig.test(a) || c.test(a) ? b("<div/>").text(a).html() : a
            }(d.alertText) + "</div>"); $alertboxBody.append("<div class='ui-sw-alert buttons'>" + f + "</div>"); a.before('<div id="' + e + 'base" class="ui-dialog-overlay-base-modal" tabindex="-1">').after("</div>"); var f = b(window).width() / 2 - a.width() / 2, m = b(window).height() / 2 + b(window).scrollTop() - a.height(); b("#" + c + "base").css({ top: "0", bottom: "0" }).fadeIn(); a.css({ position: "absolute", "z-index": "99999", left: f + "px", top: m + "px", visibility: "visible" }); b("#" +
            e + "base").css("z-index", "99998"); b("#" + c + "ok").bind("click", function () { g(); d.onOk.call(this, d.params) }); b("#" + c + "ok").keydown(function (a) { a.stopImmediatePropagation(); 13 == a.keyCode && b(this).click() }); b("#" + c + "yes").bind("click", function () { g(); d.onYes.call(this, d.params) }); b("#" + c + "yes").keydown(function (a) { a.stopImmediatePropagation(); 13 == a.keyCode && b(this).click() }); b("#" + c + "no").bind("click", function () { g(); d.onNo.call(this, d.params) }); b("#" + c + "no").keydown(function (a) {
                a.stopImmediatePropagation();
                13 == a.keyCode && b(this).click()
            }); a.css("visibility", "visible"); b(".ui-dialog-overlay-base-modal").focus()
        })
